...
export default function ApplyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Enviar aplicación como público sin token de auth
      const applyRes = await fetch(`/api/v1/candidates/apply/${processId}`, {
        method: 'POST',
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="w-full max-w-md p-6 text-center bg-white rounded-xl shadow-lg border border-gray-200">
          ...
          <p className="text-gray-600">
            Tu currículum ha sido registrado en nuestra Bolsa Global y enviado a la empresa.
            Si tu perfil coincide con lo que buscan, te contactarán pronto.
          </p>
        </div>
      </div>
    );
      ...
      <div className="max-w-2xl w-full mx-auto bg-white rounded-xl shadow-xl overflow-hidden">
        <div className="bg-slate-900 text-white p-6">
          ...
          <p className="text-slate-300 mt-2">
            Únete a nuestra base global de talento y aplica a esta vacante directamente.
          </p>
        </div>
        <div className="p-6">
