...
export declare class PortalController {
    ...
    signReceipt(id: string, req: any): Promise<{
        success: boolean;
        message: string;
    }>;
    getSelfServiceDocuments(workerId: string): Promise<{
        id: string;
        tenantId: string;
        createdAt: Date;
        name: string;
    ...
    previewSelfServiceDocument(templateId: string, workerId: string): Promise<{
        compiledHtml: string;
    }>;
    ...
    uploadFiles(workerId: string, files: Array<Express.Multer.File>): {
        success: boolean;
        urls: string[];
    };
    ...
    addTicketComment(workerId: string, ticketId: string, body: {
        text: string;
    }): Promise<{
        id: string;
        tenantId: string;
    ...
    getLoans(workerId: string, req: any): Promise<any[]>;
}
