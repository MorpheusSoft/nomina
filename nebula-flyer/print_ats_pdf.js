...
(async () => {
  ...
  console.log('Cargando la página local ATS...');
  await page.goto('http://localhost:5174/ats-pro', { waitUntil: 'networkidle0' });
  ...
  const pdfPath = '/home/lzambrano/Documents/Nebula_ATS_Corporate_Flyer.pdf';
  await page.pdf({
    path: pdfPath,
    format: 'A4',
  ...
  const pngPath = '/home/lzambrano/Documents/Nebula_ATS_Corporate_Flyer.png';
